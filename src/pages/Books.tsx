...
const testimonials = [
  {
    ...
    quote:
      "The book follows the narrative of an immigrant's plight and struggles, using universal human language that anyone can benefit from. Tweneboah's piercing clarity and poetic insight expose the lie of ordinary lives and offer a bold roadmap to rebel against cultural conformity.",
    name: "Mikey B",
  },
  {
    image: "/placeholder.svg",
    quote:
      "This book changed my perspective on what it means to live with purpose. Every chapter felt like a personal conversation with someone who truly understands the struggle of wanting more.",
    name: "Sarah M",
  },
  {
    image: "/placeholder.svg",
    quote:
      "Dionne's words are both a mirror and a map. She shows you where you've been hiding and guides you toward where you're meant to be.",
    name: "Jennifer K",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6" data-aos="fade-right">
              ...
              <p className="text-primary-foreground/70 text-sm md:text-base leading-relaxed">
                If you've ever felt the ache of living beneath your potential,
                The Tyranny of the Ordinary is your wake-up call. This
                empowering book is for every one who's tired of dimming her
                light to fit in. Through vivid storytelling, faith-fueled
                wisdom, and powerful mindset shifts, bestselling author Dionne
                Tweneboah invites you to confront the comfort zones that are
                costing you your calling.
              </p>
            ...
            >
              <div className="bg-[hsl(0,0%,90%)] p-8 rounded-lg shadow-2xl">
                <img
                  ...
                  className="w-64 md:w-80 rounded shadow-xl"
                />
              </div>
            </div>
          </div>
      ...
      <section className="py-6 bg-background border-b">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            ...
            >
              <span
                className="text-xl font-bold text-[hsl(30,100%,25%)]"
                style={{ fontFamily: "Arial, sans-serif" }}
              >
                amazon
              </span>
            ...
            <div className="space-y-6" data-aos="fade-left">
              ...
              <div className="space-y-6 text-white/90 text-lg leading-relaxed font-light">
                <p data-aos="fade-up" data-aos-delay="100">
                  There was a moment when I looked at my life and asked myself a
                  painful question: Is this all there is?
                </p>
                <p data-aos="fade-up" data-aos-delay="200">
                  From the outside, things looked fine. But on the inside, I
                  knew I was hiding. I was shrinking, settling, surviving - not
                  thriving.
                </p>
                <p data-aos="fade-up" data-aos-delay="300">
                  This book is the answer to that question. It's my love letter
                  to the person who knows they're called to more but feel stuck
                  in cycles of fear, perfectionism, or playing small.
                </p>
                <p data-aos="fade-up" data-aos-delay="400">
                  It's for the ones who secretly wonder if it's too late or if
                  they've missed their moment.
                </p>
                <p data-aos="fade-up" data-aos-delay="500">
                  <strong>It's not too late.</strong> Your purpose didn't
                  expire. The <strong>extraordinary</strong> life you crave is
                  still available, and{" "}
                  <strong>I wrote this to help you reclaim it.</strong>
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <p
              ...
              data-aos-delay="600"
            >
              If you saw yourself in even one of these... this book was written
              for you.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6 max-w-3xl mx-auto"
              data-aos="fade-up"
              data-aos-delay="100"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
            <div className="space-y-6" data-aos="fade-right">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                empowering voice and effortless elegance, Dionne helps women
                bridge the gap between their God-given calling and daily
                confidence.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Through her books, online presence, and brand collaborations,
                she has built a global community of ambitious, faith-driven
                people who are reclaiming their identity, purpose, and power.
              </p>
              <p className="italic text-muted-foreground leading-relaxed font-heading">
                When she's not writing or curating intentional style content,
                Dionne is speaking life into people across platforms, reminding
                them that ordinary was never their destiny.
              </p>
              ...
              <p className="italic text-muted-foreground">
                ...
                <br />
                Let this be the year you stop playing small and start rising
                with power.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div className="space-y-6" data-aos="fade-right">
              ...
              <p className="text-white/80 italic text-sm md:text-base leading-relaxed">
                "This is not just about winning battles—it's about becoming the
                kind of person who never bows to fear again."
              </p>

              <p className="text-white/70 text-sm md:text-base leading-relaxed">
                Conquering is for the one who's tired of shrinking under
                pressure, apologizing for her strength, or second-guessing the
                fire in her soul. This is your permission slip to rise. Whether
                you're battling fear, doubt, people-pleasing, or perfectionism,
                this book gives you the tools to break chains and walk boldly
                into the life that's been calling you.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-lg md:text-xl text-foreground max-w-3xl mx-auto">
              You don't have to fight another battle alone - or unequipped.
              <br />
              Conquering is your guide back to your boldest, most free, and most
              faith-filled self.
            </p>
